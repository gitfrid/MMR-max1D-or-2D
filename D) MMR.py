...
layout = go.Layout(
    title=f'Measles vaccination coverage max(1st or 2nd Dose) vs reported case incidence rate/1M for different countries {year_range_text}',
            ...
            buttons=[
                ...
                dict(
                    ...
                    args=[{'visible': [True] * len(traces)},
                          {'title': 'Measles Vaccination Coverage max(1st or 2nd Dose) and Reported Cases'}]
                ),
            ],
            direction='down',
            pad={'r': 10, 't': 10},
...
fig.write_html(fr"C:\MMR-max1D-or-2D\D) MMR vaccination_vs_reported_cases_dropdown_{year_range_text}.html")
