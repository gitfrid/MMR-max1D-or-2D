...
layout = go.Layout(
    title=f"Measles vaccination coverage  max(1st or 2nd Dose) vs reported case incidence rate for different countries<br>{slope_text} {year_range_text}",
    ...
    annotations=[
        ...
        dict(
            ...
            yref='paper',
            # case incidence rate per 1M
            text='case incidence rate -> https://immunizationdata.who.int/global/wiise-detail-page/measles-reported-cases-and-incidence?GROUP=Countries&YEAR=' + 
...
fig.write_html(fr"C:\MMR-max1D-or-2D\B) MMR {slope_text} {year_range_text}.html")
