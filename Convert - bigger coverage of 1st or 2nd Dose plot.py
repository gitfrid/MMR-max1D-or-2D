...
# Load the CSV files
file_1D = r"C:\MMR-max1D-or-2D\vac coverage 2025-04-03 15-07 UTC 1D.csv"
file_2D = r"C:\MMR-max1D-or-2D\vac coverage 2025-04-03 15-07 UTC 2D.csv"
...
output_file = r"C:\MMR-max1D-or-2D\max_vac_coverage_all_countries.html"
fig.write_html(output_file)
print(f"Plot saved: {output_file}")

# Save the result to a new CSV file
output_file_csv = r"C:\MMR-max1D-or-2D\max_vac_coverage_1D_or_2D.csv"  # Adjust output path if needed
