...
layout = go.Layout(
    title='Measles vaccination coverage max(1D or 2D) vs reported case incidence rate/1M for different countries',
...
fig.write_html(fr"C:\MMR-max1D-or-2D\A) MMR vaccination_vs_reported_cases {year_range_text}.html")
